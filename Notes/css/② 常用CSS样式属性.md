...
| [clip-path](https://link.juejin.cn?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FCSS%2Fclip-path) | 裁剪元素，被裁剪部分隐藏。支持多种裁剪方法，支持路径数据path | `clip-path: circle(50%)`                                     |
